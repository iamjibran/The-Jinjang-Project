    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="#candidates">Applicants</a>
          </li>
          <li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            ...
            <p><a class="btn btn-success btn-lg" href="jobs.php" role="button">Search Jobs Jinjang</a></p>
          </div>
        </div>
      </div>
    </section>
